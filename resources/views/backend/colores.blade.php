...
<div class="row justify-content-center">
    <div class="col-12">
      ...
      <div class="col-12 d-flex justify-content-end mt-3">
        ...
        <button type="button" class="btn  btn-primary" data-toggle="modal" data-target="#colorModal">Agregar <i class="fe fe-plus fe-16"></i></button>
      </div>
              ...
              <table class="table datatables" id="dataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td  class="text-start">{{ $co->nombre }}</td>
                    ...
                    <td  class="text-center">
                      ...
                      data-toggle="modal" data-target="#colorModal" onclick="Livewire.emit('asignColor',@js($co) )">
                        <i class="fe fe-edit fe-16 text-success"  data-toggle="tooltip" data-placement="top" title="Editar"></i>
                      </button>
                      <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Eliminar"  onclick="trash(@js($co->id_color))">
