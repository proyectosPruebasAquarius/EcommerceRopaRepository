            ...
            <div class="contact__form">
                <form wire:submit.prevent="cOUReview">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <input type="text" placeholder="Titulo" wire:model.lazy="title" maxlength="100" @error ('title') class="invalid" @enderror>                    
                        </div>
                        <div class="col">
                            @error('descripcion') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-12">
                            <textarea placeholder="Descripción" wire:model.lazy="descripcion" maxlength="300" @error ('descripcion') class="invalid" @enderror></textarea>
                    ...
                    <div class="card-body">                        
                        <div class="rating">                            
                            <div class="row no-gutters">
                                <div class="col-6">
                                    <img src="{{ asset('frontend/img/user.svg') }}" alt="{{ auth()->user()->name }}" class="rounded-lg" width="50" height="50">
                                </div>
                            ...
                            <i class="fa @if ($mR->rating == 0.5) fa-star-half-o @elseif($mR->rating >= 1) fa-star @else fa-star-o @endif"></i>
                            <i class="fa @if ($mR->rating == 1.5) fa-star-half-o @elseif($mR->rating >= 2) fa-star @else fa-star-o @endif"></i>
                            <i class="fa @if ($mR->rating == 2.5) fa-star-half-o @elseif($mR->rating >= 3) fa-star @else fa-star-o @endif"></i>
                            <i class="fa @if ($mR->rating == 3.5) fa-star-half-o @elseif($mR->rating >= 4) fa-star @else fa-star-o @endif"></i>
                            <i class="fa @if ($mR->rating == 4.5) fa-star-half-o @elseif($mR->rating == 5) fa-star @else fa-star-o @endif"></i>  
                            <p>
                                @if($mR->title)
