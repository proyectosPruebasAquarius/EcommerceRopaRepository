...
/*     $("select").niceSelect(); */
    ...
    $("#countdown").countdown(timerdate, function (event) {
        $(this).html(event.strftime("<div class='cd-item'><span>%D</span> <p>Días</p> </div>" + "<div class='cd-item'><span>%H</span> <p>Horas</p> </div>" + "<div class='cd-item'><span>%M</span> <p>Minutos</p> </div>" + "<div class='cd-item'><span>%S</span> <p>Segundos</p> </div>"));
    });
